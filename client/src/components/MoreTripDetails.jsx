            ...
            <div style={{ height: '200px' }}>
              ...
              >
                ...
                Nights
                  ...
                  <p style={{
                    color: '#4c4c4c', marginTop: '-10px', fontWeight: '400', float: 'left',
                  }}
                  >
                    Accommodation
                  </p>
              ...
              >
                ...
                <div style={{
                  display: 'block', height: '100px', width: '180px', float: 'left', paddingLeft: '6px',
                }}
                >
                  <h4 style={{
                    textTransform: 'uppercase', fontWeight: '800', color: '#4c4c4c', marginTop: '0',
            ...
            >
              {difference1.map((diff, index) => (
                ...
                >
                  ...
                  <div style={{
                    float: 'left', display: 'block', width: '200px', paddingLeft: '6px',
                  }}
                  >
                ...
                >
                  {travels1.map((highlight, index) => (
                    <p key={index} style={{ color: '#4c4c4c', fontWeight: '400', width: '100%' }}>
                      ...
                      <div style={{ float: 'left', width: '100%', padding: '15px 0 15px 0' }}>
                        <div style={{ display: 'block', float: 'left' }}>
                          <img
                            style={{
                              height: '15px', width: '15px', float: 'left', marginRight: '10px',
                            }}
                            src="https://front-end-capstone-trafalgar.s3-us-west-1.amazonaws.com/checkmark.svg.png"
                            alt="checkmark"
                          />
                        </div>
                        <div style={{ float: 'left', width: '350px' }}>{highlight}</div>
                      </div>
                    </p>
                  ))}
                </div>
